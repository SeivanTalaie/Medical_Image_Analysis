...
image_dir="C:/Datasets/Brats2020/Input_data_npy/train/image"
mask_dir="C:/Datasets/Brats2020/Input_data_npy/train/mask"
...
training_image_dir="C:/Datasets/input_data/train/images/"
training_mask_dir="C:/Datasets/input_data/train/masks"
training_image_list=os.listdir(training_image_dir)
training_mask_list=os.listdir(training_mask_dir)

validation_image_dir="C:/Datasets/input_data/val/images"
validation_mask_dir="C:/Datasets/input_data/val/masks"
validation_image_list=os.listdir(validation_image_dir)
validation_mask_list=os.listdir(validation_mask_dir)

test_image_dir="C:/Datasets/input_data/test/images"
test_mask_dir="C:/Datasets/input_data/test/masks"
...
save_path="H:/former_method/resnet34_without_classWeights/resnet34_weights/"

ModelChechPoint=keras.callbacks.ModelCheckpoint(save_path + "Resnet34_{epoch}__{val_iou_score:.4f}__{val_loss}.hdf5" ,
...
model_path="H:/former_method/resnet34_without_classWeights/resnet34_weights/"
my_model=load_model(model_path + "Resnet34_41__0.7774__0.14221149682998657.hdf5",compile=False)


y_pred=my_model.predict(test_img)
y_pred_argmax=np.argmax(y_pred , axis=3)
y1=np.argmax(test_mask ,axis=3)
