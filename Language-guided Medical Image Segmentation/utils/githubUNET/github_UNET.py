...
class UNet(nn.Module):
    def __init__(self, n_channels = 3, n_classes = 1, bilinear=False):
        ...
        self.norm = AugmentationSequential(Normalize(mean=torch.tensor([0.485, 0.456, 0.406]),
                                                     std=torch.tensor([0.229, 0.224, 0.225])))

        print("-"*50)
        print('UNet: NoAug + NoText')
        print("-"*50)
    ...
    def forward(self, data):
        ...
        return torch.sigmoid(logits), gt
...
if __name__ == "__main__":
    ...
    print(f"Total FLOPs: {flops.total()/1e9}")  # 总 FLOPs
    print(f"Total Parameters: {params/1e6}")  # 总参数量